...
class RecallAtK_kaleido(BaseMetric):
    ...
    def calculate(
        ...
        **kwargs,
        ...
        image_cat_ids = sample_list["image_cat_id"]
        text_cat_ids = sample_list["text_cat_id"]
        ...
        image_cat_ids = torch.cat(all_gather_diff_size(image_cat_ids), dim=0)
        text_cat_ids = torch.cat(all_gather_diff_size(text_cat_ids), dim=0)
