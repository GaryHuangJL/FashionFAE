...
class ViTEncoder(Encoder):
    ...
    def forward(self, *args, **kwargs):
        ...
        output = self.module(*args, **kwargs)
        image_embedding = output["last_hidden_state"][:, 1:].view(-1, 14, 14, 768)

        image_itc = output["last_hidden_state"]
        image_embedding = image_embedding.permute(0, 3, 1, 2)
