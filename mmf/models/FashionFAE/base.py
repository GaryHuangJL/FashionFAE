...
class FashionFAEBase(BertPreTrainedModel):
    def __init__(
        self,
        config,
    ...
    def forward(
        ...
        inputtext_embeddings: Optional[Tensor] = None,
        ...
        extended_text_attention_mask = None
        ...
        embedding_output = self.embeddings(
            input_ids,
            token_type_ids,
            inputtext_embeddings=inputtext_embeddings,
            visual_embeddings=visual_embeddings,
            visual_embeddings_type=visual_embeddings_type,
        )

        encoded_layers = self.encoder(embedding_output, extended_attention_mask,use_all=use_all)
    ...
    def get_mpfc_embedding(
        self,
        inputtext_embeddings: Tensor,
        visual_embeddings: Tensor,
        visual_embeddings_type: Tensor,
        attention_mask: Tensor,
    ) -> Tuple[Tensor, Tensor, List[Tensor]]:
...
class FashionFAEBaseModel(nn.Module):
    def __init__(self, config):
        ...
        self.config = config
        self.bert = FashionFAEBase.from_pretrained(
            bert_model_name,
            config=bert_config,
